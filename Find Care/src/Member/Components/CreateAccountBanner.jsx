const CreateAccountBanner = () => {
  return (
    <div className="flex bg-primary rounded-lg  sm:px-10 md:px-14 lg:px-12  mb-10 lg:my-20">
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5 text-center lg:text-left">
